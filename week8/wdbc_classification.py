...
if __name__ == '__main__':
    ...
    # Train a model
    model = RandomForestClassifier()           # TODO #2) Find a better classifier (SVC accuracy: 0.902)
    ...
    plt.figure()
    sns.heatmap(cm, annot=True, fmt="d", xticklabels=wdbc.target_names, yticklabels=wdbc.target_names)
